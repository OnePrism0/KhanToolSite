...
const repoPath = `https://raw.githubusercontent.com/OnePrism0/KhanTool/refs/heads/${isDev ? "dev/" : "main/"}`;
...
/* Inject */
if (!/^https?:\/\/([a-z0-9-]+\.)?khanacademy\.org/.test(window.location.href)) { alert("❌ KhanTool Failed to Injected!\n\nVocê precisa executar o KhanTool no site do Khan Academy! (https://pt.khanacademy.org/)"); window.location.href = "https://pt.khanacademy.org/"; }
