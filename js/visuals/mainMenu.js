...
watermark.innerHTML = `<span style="text-shadow: -1px 0.5px 0 #1151e2, -2px 0px 0 #1151e2;">KT</span> <span style="color:gray; padding-left:2px; font-family: Arial, sans-serif; font-size:10px">${ver}</span>`;
...
dropdownMenu.innerHTML = `
    <style>
        ...
        input[type="checkbox"]:checked {background-color: #1151e2; border-color: #1151e2;}
        input[type="text"], input[type="number"], input[type="range"] {width: calc(100% - 10px); border: 1px solid #343434; 
        color: white; accent-color: #1151e2; background-color: #1151e2; padding: 3px; border-radius: 3px; background: none;}
